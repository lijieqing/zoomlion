...
//		}
    ...
    private void BAM_SendDTFrame(J1939_txMsg_ts pTxMsg) {
        ...
        if (System.currentTimeMillis() < j1939_TxCfg.bam_minTimeout_u32)
            return;                    //	BAM帧间隔太小，还未到广播下一帧的时间
     ...
     * @param buf_pas:   发送缓冲区
     * @param numMsg_16: numMsg_u16:	发送缓冲区大小（FIFO项数）
     * @return： CAN_ERR_NO_ERRORS_DU16 :	无错误
     ...
     * @param numMsg_16: 接收缓冲区大小（FIFO项数）
     * @return ：
     ...
     * @param cycleTime_u16 :		J1939任务的运行周期 ， 1 -- 90ms, 推荐10ms
...
//		}
     ...
     * @param pCallbackArg： 回调函数调用参数
     * @return： J1939_RC_NO_ERRORS_DU16 :			无错误
     * J1939_RC_INV_DATABOX_DU16：			数据箱索引无效
     * J1939_RC_INV_PGN_DU16:				PGN无效
     ...
     * @return： J1939_RC_NO_ERRORS_DU16        --  Function was executed without errors.
     ...
     * @return: J1939_RC_DM1_NOT_EXIST_DU16        --   DM1 failure does not exist within DM1 failure list.
